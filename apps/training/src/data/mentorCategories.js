...
export const MENTOR_CATEGORIES = {
  ...
  national: {
    key: 'national',
    title: '国家级质控中心病例',
    desc: '依据国家医疗质控指标，汇集急危重症与重点病种典型案例，推动诊疗规范化',
    ...
    centers: [
      {
        name: '国家综合介入技术质控中心',
        intro: '牵头制定介入诊疗质控标准与评审规范，推动介入技术临床应用同质化。',
        cases: [
          ...
          { patientName: '高**', gender: '女', age: 54, disease: '不稳定型心绞痛', specialty: '心血管内科', difficulty: 'R1', caseLevel: '基础病例', symptoms: ['活动后胸痛', '心前区压榨感'], level: '多发病' },
          ...
          { patientName: '罗**', gender: '男', age: 52, disease: '颅内动脉瘤', specialty: '神经外科', difficulty: 'R3', caseLevel: '疑难病例', symptoms: ['突发剧烈头痛', '颈项强直'], level: '危重病' },
          { patientName: '宋**', gender: '男', age: 60, disease: '颈动脉狭窄', specialty: '介入与血管外科', difficulty: 'R2', caseLevel: '高阶病例', symptoms: ['头晕', '一过性黑朦'], level: '常见病' },
          { patientName: '薛**', gender: '男', age: 58, disease: '肝癌（TACE）', specialty: '肿瘤科', difficulty: 'R2', caseLevel: '高阶病例', symptoms: ['右上腹痛', '消瘦'], level: '疑难病' },
          { patientName: '潘**', gender: '男', age: 61, disease: '肝癌伴门静脉癌栓', specialty: '肿瘤科', difficulty: 'R3', caseLevel: '疑难病例', symptoms: ['腹胀', '黄疸', '腹水'], level: '危重病' },
          { patientName: '魏**', gender: '男', age: 65, disease: '肺癌（微波消融）', specialty: '肿瘤科', difficulty: 'R2', caseLevel: '高阶病例', symptoms: ['咳嗽', '痰中带血', '胸痛'], level: '疑难病' },
          { patientName: '崔**', gender: '女', age: 58, disease: '急性肺栓塞', specialty: '呼吸内科', difficulty: 'R2', caseLevel: '疑难病例', symptoms: ['突发胸痛', '咯血', '呼吸困难'], level: '危重病' },
          { patientName: '于**', gender: '男', age: 57, disease: '下肢深静脉血栓', specialty: '血管外科', difficulty: 'R1', caseLevel: '基础病例', symptoms: ['下肢肿胀', '疼痛'], level: '多发病' },
          { patientName: '蔡**', gender: '男', age: 63, disease: '主动脉夹层', specialty: '心血管外科', difficulty: 'R3', caseLevel: '疑难病例', symptoms: ['撕裂样胸背痛', '血压不对称'], level: '危重病' },
          { patientName: '姜**', gender: '女', age: 65, disease: '腹主动脉瘤', specialty: '血管外科', difficulty: 'R2', caseLevel: '疑难病例', symptoms: ['腹部搏动性包块', '腹痛'], level: '疑难病' },
          { patientName: '胡**', gender: '男', age: 55, disease: '急性上消化道出血', specialty: '消化内科', difficulty: 'R2', caseLevel: '疑难病例', symptoms: ['呕血', '黑便'], level: '危重病' },
          { patientName: '袁**', gender: '女', age: 62, disease: '肝硬化门脉高压食管胃底静脉曲张破裂出血', specialty: '消化内科', difficulty: 'R3', caseLevel: '疑难病例', symptoms: ['呕血', '腹胀', '黄疸'], level: '危重病' },
          { patientName: '董**', gender: '男', age: 48, disease: '急性大咯血', specialty: '呼吸内科', difficulty: 'R2', caseLevel: '疑难病例', symptoms: ['咯鲜血', '胸闷'], level: '危重病' },
          { patientName: '苏**', gender: '男', age: 35, disease: '肾动脉狭窄', specialty: '肾内科', difficulty: 'R2', caseLevel: '高阶病例', symptoms: ['血压难以控制', '下肢乏力'], level: '疑难病' },
          { patientName: '温**', gender: '女', age: 42, disease: '胆道梗阻', specialty: '肝胆外科', difficulty: 'R2', caseLevel: '疑难病例', symptoms: ['黄疸', '皮肤瘙痒', '腹痛'], level: '疑难病' },
          { patientName: '夏**', gender: '男', age: 32, disease: '急性下肢动脉栓塞', specialty: '血管外科', difficulty: 'R2', caseLevel: '高阶病例', symptoms: ['下肢突发剧痛', '皮肤苍白'], level: '危重病' }
        ]
      },
      {
        name: '国家重症医学质控中心',
        intro: '构建重症医学质控指标体系，促进重症救治规范化、标准化。',
        cases: [
          { patientName: '何**', gender: '男', age: 70, disease: '急性心力衰竭', specialty: '心血管内科', difficulty: 'R3', caseLevel: '疑难病例', symptoms: ['端坐呼吸', '双下肢水肿'], level: '危重病' },
          { patientName: '丁**', gender: '女', age: 66, disease: '慢性心力衰竭急性加重', specialty: '心血管内科', difficulty: 'R2', caseLevel: '高阶病例', symptoms: ['活动后气促', '夜间阵发性呼吸困难'], level: '危重病' },
          { patientName: '唐**', gender: '男', age: 72, disease: '重症肺炎', specialty: '呼吸内科', difficulty: 'R2', caseLevel: '疑难病例', symptoms: ['发热', '咳嗽', '呼吸困难'], level: '危重病' },
          { patientName: '林**', gender: '男', age: 68, disease: '急性呼吸窘迫综合征', specialty: '呼吸内科', difficulty: 'R3', caseLevel: '疑难病例', symptoms: ['进行性呼吸困难', '低氧血症'], level: '危重病' },
          { patientName: '许**', gender: '男', age: 65, disease: '慢性阻塞性肺疾病急性加重（II型呼吸衰竭）', specialty: '呼吸内科', difficulty: 'R2', caseLevel: '疑难病例', symptoms: ['咳嗽咳痰', '气促加重', '嗜睡'], level: '危重病' },
          ...
          { patientName: '曹**', gender: '男', age: 60, disease: '脓毒性休克', specialty: '急诊科', difficulty: 'R3', caseLevel: '疑难病例', symptoms: ['高热', '血压下降', '意识淡漠'], level: '危重病' },
          { patientName: '严**', gender: '男', age: 50, disease: '急性重症胰腺炎', specialty: '消化内科', difficulty: 'R3', caseLevel: '疑难病例', symptoms: ['上腹痛', '恶心呕吐', '腹膜炎体征'], level: '危重病' },
          { patientName: '邓**', gender: '女', age: 35, disease: '暴发性心肌炎', specialty: '心血管内科', difficulty: 'R3', caseLevel: '疑难病例', symptoms: ['心悸', '胸闷', '低血压'], level: '危重病' },
          { patientName: '石**', gender: '男', age: 22, disease: '急性早幼粒细胞白血病', specialty: '血液内科', difficulty: 'R3', caseLevel: '疑难病例', symptoms: ['发热', '皮肤瘀点', '牙龈出血'], level: '危重病' },
          { patientName: '田**', gender: '男', age: 45, disease: '弥散性血管内凝血', specialty: '血液内科', difficulty: 'R3', caseLevel: '疑难病例', symptoms: ['多部位出血', '血压下降'], level: '危重病' },
          { patientName: '洪**', gender: '男', age: 38, disease: '急性肾损伤', specialty: '肾内科', difficulty: 'R2', caseLevel: '高阶病例', symptoms: ['少尿', '水肿'], level: '疑难病' },
          { patientName: '杜**', gender: '女', age: 32, disease: '产后大出血', specialty: '妇产科', difficulty: 'R3', caseLevel: '疑难病例', symptoms: ['阴道大量出血', '血压下降'], level: '危重病' },
          { patientName: '陶**', gender: '女', age: 29, disease: '重度子痫前期', specialty: '妇产科', difficulty: 'R2', caseLevel: '高阶病例', symptoms: ['血压升高', '蛋白尿', '头痛'], level: '疑难病' },
          { patientName: '金**', gender: '男', age: 36, disease: '重型颅脑损伤', specialty: '神经外科', difficulty: 'R2', caseLevel: '疑难病例', symptoms: ['昏迷', '瞳孔异常'], level: '危重病' },
          { patientName: '秦**', gender: '男', age: 55, disease: '脑出血（重症）', specialty: '神经内科', difficulty: 'R3', caseLevel: '疑难病例', symptoms: ['突发头痛', '恶心呕吐', '意识障碍'], level: '危重病' },
          { patientName: '叶**', gender: '女', age: 58, disease: '重症肌无力危象', specialty: '神经内科', difficulty: 'R3', caseLevel: '疑难病例', symptoms: ['肌无力加重', '呼吸困难'], level: '危重病' },
          { patientName: '康**', gender: '男', age: 42, disease: '热射病', specialty: '急诊科', difficulty: 'R2', caseLevel: '疑难病例', symptoms: ['高热', '意识障碍', '无汗'], level: '危重病' },
          { patientName: '毛**', gender: '男', age: 28, disease: '急性有机磷中毒', specialty: '急诊科', difficulty: 'R2', caseLevel: '疑难病例', symptoms: ['瞳孔缩小', '流涎', '肌束震颤'], level: '危重病' }
        ]
      }
    ]
  }
