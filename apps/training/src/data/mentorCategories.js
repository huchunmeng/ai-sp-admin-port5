    ...
    mentors: [
      {
        ...
        cases: [
          { patientName: '患者一', gender: '男', age: 58, disease: '胆管癌', specialty: '介入与血管外科', difficulty: 'R2', caseLevel: '疑难病例', symptoms: ['黄疸', '上腹痛'], level: '常见病' },
          { patientName: '患者二', gender: '男', age: 52, disease: '肝癌', specialty: '介入与血管外科', difficulty: 'R1', caseLevel: '基础病例', symptoms: ['右上腹隐痛', '乏力'], level: '常见病' },
          { patientName: '患者三', gender: '男', age: 61, disease: '肝癌（TACE+冷冻消融）', specialty: '介入与血管外科一', difficulty: 'R2', caseLevel: '高阶病例', symptoms: ['腹胀', '消瘦'], level: '常见病' },
          { patientName: '患者四', gender: '男', age: 55, disease: '肝癌（TACE）', specialty: '介入与血管外科一', difficulty: 'R2', caseLevel: '疑难病例', symptoms: ['纳差', '肝区不适'], level: '常见病' },
          { patientName: '患者五', gender: '男', age: 64, disease: '颈动脉狭窄', specialty: '江北介入与血管外科', difficulty: 'R1', caseLevel: '基础病例', symptoms: ['头晕', '一过性黑朦'], level: '常见病、多发病' }
        ]
      }
    ]
  },
  mentor: {
    ...
    mentors: [
      ...
      },
      {
        ...
        cases: [
          { patientName: '患者十一', gender: '男', age: 66, disease: '前列腺癌', specialty: '泌尿外科', difficulty: 'R2', caseLevel: '疑难病例', symptoms: ['排尿困难', '血尿'], level: '疑难病' },
          { patientName: '患者十二', gender: '男', age: 71, disease: '前列腺癌', specialty: '泌尿外科', difficulty: 'R3', caseLevel: '疑难病例', symptoms: ['尿频', '夜尿增多'], level: '疑难病' },
          { patientName: '患者十三', gender: '男', age: 59, disease: '前列腺癌', specialty: '泌尿外科', difficulty: 'R2', caseLevel: '高阶病例', symptoms: ['PSA升高', '下尿路症状'], level: '疑难病' },
          { patientName: '患者十四', gender: '男', age: 63, disease: '前列腺癌', specialty: '泌尿外科', difficulty: 'R2', caseLevel: '疑难病例', symptoms: ['骨痛', '排尿费力'], level: '疑难病' },
          { patientName: '患者十五', gender: '男', age: 68, disease: '前列腺癌', specialty: '泌尿外科', difficulty: 'R3', caseLevel: '疑难病例', symptoms: ['血尿', '腰背痛'], level: '疑难病' }
        ]
      },
      {
        name: '李玲',
        ...
        cases: [
          { patientName: '患者六', gender: '女', age: 47, disease: '糖尿病', specialty: '内分泌科', difficulty: 'R1', caseLevel: '基础病例', symptoms: ['多饮', '多尿', '消瘦'], level: '多发病' },
          { patientName: '患者七', gender: '男', age: 39, disease: '黑棘皮病', specialty: '内分泌科', difficulty: 'R1', caseLevel: '基础病例', symptoms: ['皮肤色素沉着', '皮损'], level: '多发病' },
          { patientName: '患者八', gender: '男', age: 62, disease: '2型糖尿病性足病', specialty: '内分泌科', difficulty: 'R3', caseLevel: '高阶病例', symptoms: ['足部破溃', '感觉减退'], level: '危重病' },
          { patientName: '患者九', gender: '女', age: 28, disease: '中枢性尿崩症', specialty: '内分泌科', difficulty: 'R2', caseLevel: '疑难病例', symptoms: ['烦渴', '多尿'], level: '疑难病' },
          { patientName: '患者十', gender: '男', age: 57, disease: '2型糖尿病性足病', specialty: '内分泌科', difficulty: 'R3', caseLevel: '疑难病例', symptoms: ['足趾坏疽', '间歇性跛行'], level: '危重病' }
        ]
      },
      {
        name: '陆玲',
